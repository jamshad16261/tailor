...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="page-header-title">
                                <h4 class="mb-0">Tailor Performance Report</h4>
                            </div>
                        </div>
                        <div class="col-md-6 text-end">
                            <ul class="breadcrumb justify-content-end mb-0">
                                ...
                                <li class="breadcrumb-item active">Tailor Performance Report</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="text-primary fw-semibold mb-0">
                            <i class="fa-solid fa-chart-line me-2"></i>Tailor Performance Report Overview
                        </h5>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-sm" id="tailor_id" name="tailor_id">
                                <option value="">All Tailor</option>
                                <?php
                                $bId = $_SESSION['business_id'];
                                $qry = $this->db->query("SELECT id, name FROM users WHERE is_deleted = 0 AND business_id = $bId AND role ='tailor' ORDER BY name ASC");
                        ...
                        <table class="table table-bordered table-sm" style="font-size:12px; border-collapse: collapse;">
                            <thead class="table-light">
                                <tr style="padding:2px !important;">
                                    ...
                                    <th style="padding:2px 4px !important;">Pending Orders</th>
                                    <th style="padding:2px 4px !important;">Delivered Orders</th>
                                </tr>
                            </thead>
                            <tbody id="showTailorPerformance"></tbody>
                        </table>
    ...
    <script>
            ...
            a.download = 'Tailor Performance Report.xls';
            a.click();
        });
        $('#btnPdf').click(() => {
            html2pdf(document.querySelector('.table-responsive'), {
                filename: 'Tailor Performance Report.pdf',
                margin: 10,
                pagebreak: {
                    mode: ['avoid-all']
                },
        ...
        $(document).ready(function() {
            $('#btnSearch').on('click', function() {
                ...
                $.ajax({
                    url: "<?= base_url('Reports/getTailorPerformance') ?>",
                    type: "POST",
                    dataType: "json",
                    data: {
                        tailor_id: tailor_id,
                    ...
                    <td colspan="9" class="text-center text-danger">
                        ...
                        $('#showTailorPerformance').html(html);
                    }
                });
            });
